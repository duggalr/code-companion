...
const MainLayout = () => {
    ...
    return (
        ...
        // f5f5f5
        // f3f3f3
      <div className="flex h-screen" style={{ backgroundColor: "#f3f3f3" }}>
        ...
        <ResizableBox
            ...
            handle={
                ...
                <div
                    className="w-2 bg-gray-400 hover:bg-gray-600 cursor-ew-resize h-full absolute right-0 top-0 group-hover:w-4 transition-all duration-300 flex items-center justify-center"
