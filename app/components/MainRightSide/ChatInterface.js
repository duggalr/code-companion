...
const ChatInterface = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-100 dark:bg-gray-800 p-4">
      ...
      <div className="flex-grow overflow-y-auto p-4 space-y-3 border border-gray-300 dark:border-gray-600 rounded-md">
        {messages.length > 0 ? (
      ...
      <div className="flex flex-col border-t border-gray-300 dark:border-gray-600 pt-2 mt-2">
        <textarea
          ...
          className="resize-none p-3 bg-white dark:bg-gray-700 dark:text-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mb-2"
