      ...
      <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 dark:bg-gray-900">
          <ul class="flex flex-wrap -mb-px">
              <li class="me-2">
                  ...
                  className={`inline-block p-0 px-6 pb-2 pt-3 text-gray-500 rounded-t-lg active dark:border-blue-500 cursor-pointer ${activeTab === "console" ? "border-b-2 border-gray-300 text-gray-700 dark:text-blue-500 dark:border-blue-500" : ""}`}
                  aria-current="page"
              ...
              <li class="me-2">
                  <a
                  class={`inline-block p-0 px-6 pb-2 pt-3 rounded-t-lg text-gray-500 hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 cursor-pointer ${activeTab === "chat" ? "border-b-2 border-gray-300 text-gray-700 dark:text-blue-500 dark:border-blue-500 " : ""}`}
